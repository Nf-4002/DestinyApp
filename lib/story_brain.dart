...
class StoryBrain {
  // Private property to hold the stories
  ...
  // Property to track the current story
  int _storyNumber = 0;

  // Method to get the current story title
  String getStory() {
    return _storyData[_storyNumber].storyTitle;
  }

  // Method to get the first choice text
  String getChoice1() {
    return _storyData[_storyNumber].choice1;
  }

  // Method to get the second choice text
  String getChoice2() {
